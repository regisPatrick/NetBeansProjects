 ...
 * 
 */
@WebServiceClient(name = "HelloWorld", targetNamespace = "http://ws.exemplo/", wsdlLocation = "http://localhost:8080/HelloWorld/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLD_QNAME = new QName("http://ws.exemplo/", "HelloWorld");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://ws.exemplo/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.exemplo/", "HelloWorldPort"), HelloWorld.class, features);
    }
