 ...
 * @author user
 */
@WebServlet(name = "EditorServletAlterar", urlPatterns = {"/EditorServletAlterar"})
public class EditorServletAlterar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("editor_alterar.jsp").forward(request, response);
    }
