 ...
 * @author user
 */
@WebServlet(name = "EditoraServletCadastrar", urlPatterns = {"/EditoraServletCadastrar"})
public class EditoraServletCadastrar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("editora_cadastrar.jsp").forward(request, response);
    }
}